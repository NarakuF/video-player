    ...
    render() {
        return (
            <div className='row'>
                ...
                <div id='playlist' className='col-md-2'>
                    <table className='table table-sm table-striped table-bordered text-center'>
                        <thead className='rec-h'>
                        <tr className='rec-r'>
                            <th className='rec-h'>Playlist</th>
                        </tr>
                        </thead>
                        <tbody className='rec-b'>
                        {this.state.playlist.map(v => {
                            return (
                                <tr className='rec-r' key={v.src.substr(v.src.indexOf('=') + 1)}>
                                    <td className='rec-d'>
                                        <button
                                            className={'btn btn-outline-primary'}
                                            onClick={() => {
                                                console.log(v);
                                                this.player.src({type: v.type, src: v.src})
                                            }}>
                                            {v.src.substr(v.src.indexOf('=') + 1)}</button>
                                    </td>
                                </tr>)
                        })}
                        </tbody>
                ...
                <div id='video_player' data-vjs-player className='col-md-8'>
